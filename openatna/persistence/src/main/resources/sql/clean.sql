DROP TABLE atna_messages CASCADE;
DROP TABLE atna_objects CASCADE;
DROP TABLE atna_events CASCADE;
DROP TABLE atna_participants CASCADE;
DROP TABLE atna_sources CASCADE;

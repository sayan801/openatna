...
DROP TABLE message_objects_object_details CASCADE;
DROP TABLE message_participants CASCADE;
DROP TABLE message_sources CASCADE;
DROP TABLE messages CASCADE;

DROP TABLE messages_message_objects CASCADE;
DROP TABLE messages_message_participants CASCADE;
DROP TABLE messages_message_sources CASCADE;
